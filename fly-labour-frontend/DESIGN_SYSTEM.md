...
```css
/* ── Light Mode (:root) ── */
--background: #fafaf9 /* Nền trang */ --surface: #ffffff /* Card, panel */
  --surface-secondary: #f5f5f3 /* Panel thứ cấp */ --text-base: #2a2a2a
  --text-secondary: #626262 --text-tertiary: #a0a09f --border-default: #e5e5e4
  --border-subtle: #d4d4d2 --border-strong: #b8b8b6 --accent-primary: #e4a808
  /* Gold — không đổi */ --accent-secondary: #ff9500 /* Orange — không đổi */
  /* ── Dark Mode (html.dark) ── */ --background: #0f0f0e --surface: #1a1a19
  --surface-secondary: #262624 --text-base: #f0f0ee --text-secondary: #b8b8b6
  --text-tertiary: #7a7a78 --border-default: #3a3a38 --border-subtle: #2a2a28
...
>
  ...
  <Flame
    size={22}
    className="text-yellow-300 fill-yellow-300 animate-pulse relative z-10"
  />
